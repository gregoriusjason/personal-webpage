...
function smoothScrollTo(id: string, container: HTMLElement | null){
  if(!container) return
...
export default function Home(){
  ...
  const handleProjectScroll=(direction:'left'|'right')=>{
    ...
    const scrollAmount=card? (card.offsetWidth+24): Math.min(600,Math.max(320,Math.floor(track.clientWidth*0.9)))
  ...
  useEffect(()=>{
    ...
    const updateIndex=()=>{
      ...
      animFrame=requestAnimationFrame(()=>{
        ...
        setcurrentProjIndex(best)
      })
    }
    track.addEventListener('scroll',updateIndex,{passive:true})
    updateIndex()
    return()=>{track.removeEventListener('scroll',updateIndex);cancelAnimationFrame(animFrame)}
  },[])
  ...
  useEffect(()=>{
    ...
    const onMainScroll=()=>{ setShowHeader(mainEl.scrollTop>24) }
    onMainScroll()
  ...
  useEffect(()=>{
    const onKeyDown=(e:KeyboardEvent)=>{ if(e.key==='Escape') setActiveProject(null) }
  ...
  return (
    <div className="fixed inset-0 w-full h-full bg-[#f7f8fb] relative overflow-hidden select-none">
      ...
      <main ref={mainScrollRef} className="absolute inset-0 mx-auto max-w-6xl px-6 pt-20 pb-24 snap-y snap-mandatory overflow-y-auto scrollbar-hide">
        <section id="about" className="relative min-h-[calc(100dvh-176px)] grid place-items-center py-0 snap-start scroll-mt-24 md:scroll-mt-28">
          <div className="relative mx-auto w-full max-w-5xl overflow-hidden rounded-[2rem] border border-black/10 bg-[#eaf2ff] shadow-[0_8px_30px_rgba(0,0,0,0.06)] p-5 sm:p-8 md:p-10 animate-fade-in hover:shadow-[0_16px_44px_rgba(0,0,0,0.08)] transition-shadow">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className="w-full">
                <div className="relative rounded-[1.5rem] bg-[#dfe8ff] p-6 md:p-8 shadow-inner animate-fade-in delay-100">
                  ...
                  <div className="mt-6 md:mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                    <a href="mailto:gregoriusjason@outlook.com" className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-medium text-slate-800 shadow hover:bg-slate-50 transition-colors">
              ...
              <div className="animate-fade-in delay-200">
                ...
                <p className="text-lg md:text-xl text-slate-900 mb-1">My name is <span className="font-extrabold">Gregorius Jason</span></p>
                <p className="text-slate-800 mb-5">I’m a second year <span className="font-semibold">Computer Science</span> student<br className="hidden sm:block" />at the <span className="font-semibold">University of Edinburgh</span>.</p>
                <div className="flex items-center gap-3 mb-6 animate-fade-in delay-400">
                  <a href="#resume" onClick={(e)=>{e.preventDefault();smoothScrollTo('resume',mainScrollRef.current)}} className="inline-flex items-center gap-2 rounded-full bg-[#2a6dfd] px-5 py-2 text-white text-sm font-semibold shadow hover:bg-[#1f5ae0] active:scale-[0.98] transition-all">RESUME</a>
                  <a href="#projects" onClick={(e)=>{e.preventDefault();smoothScrollTo('projects',mainScrollRef.current)}} className="inline-flex items-center gap-2 rounded-full border border-slate-400/60 bg-transparent px-5 py-2 text-sm font-semibold text-slate-900 hover:bg-white/60 active:scale-[0.98] transition-all">PROJECTS</a>
                </div>
                <p className="max-w-xl text-base md:text-[17px] leading-relaxed text-slate-800">
                  I am an innovative, disciplined, and analytical Computer Science student with a strong fascination for artificial intelligence. My ambition is to become a Software Engineer who applies AI to create meaningful societal impact—designing technology that simplifies tasks, enhances efficiency, and solves real-world problems.
                </p>
              </div>
            </div>
          </div>
          ...
          <a href="#resume" onClick={(e)=>{e.preventDefault();smoothScrollTo('resume',mainScrollRef.current)}} className="hidden sm:flex absolute bottom-3 left-1/2 -translate-x-1/2 items-center gap-2 text-slate-600/70 hover:text-slate-900 transition-colors">
            ...
            <svg className="h-5 w-5 animate-bounce" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 16a1 1 0 0 1-.7-.29l-6-6 1.4-1.42L12 13.6l5.3-5.31 1.4 1.42-6 6c-.18.18-.43.29-.7.29Z"/></svg>
          </a>
        </section>
        ...
        <section id="resume" className="py-12 md:py-16 snap-start scroll-mt-24 md:scroll-mt-28">
          <div className="rounded-xl border border-black/10 bg-white/80 backdrop-blur-md p-6 md:p-8 shadow-sm">
            ...
            <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-[#2a6dfd] bg-[#2a6dfd]/10 px-4 py-2 text-sm font-semibold text-[#2a6dfd] hover:bg-[#2a6dfd]/20 hover:text-[#1f5ae0] transition-all">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"><path d="M6 2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7.828A2 2 0 0 0 15.414 7L13 4.586A2 2 0 0 0 11.586 4H6Z" /></svg>
              View my Resume (PDF)
            </a>
          </div>
        </section>
        ...
        <section id="projects" className="pb-24 snap-start scroll-mt-24 md:scroll-mt-28">
          <div className="rounded-xl border border-black/10 bg-white/80 backdrop-blur-md p-6 md:p-8 shadow-sm">
            ...
            <div className="relative">
              ...
              <div ref={carouselTrackRef} role="region" aria-label="Projects carousel" tabIndex={0} className="flex gap-6 overflow-x-auto snap-x snap-mandatory scroll-px-6 px-1 py-3 scrollbar-hide [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                <article data-card className="group relative snap-center shrink-0 w-[88%] sm:w-[64%] md:w-[52%] lg:w-[44%] xl:w-[38%] 2xl:w-[32%] rounded-2xl border border-black/10 bg-white/80 backdrop-blur shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-transform duration-300 will-change-transform hover:-translate-y-1 hover:scale-[1.03] hover:shadow-[0_16px_44px_rgba(0,0,0,0.08)]">
                  <a href="#" className="block">
                    ...
                    <div className="p-5 md:p-6">
                      ...
                      <button type="button" onClick={()=>setActiveProject(0)} className="mt-5 inline-flex items-center gap-2 text-[#2a6dfd] font-semibold hover:underline">
                ...
                <article data-card className="group relative snap-center shrink-0 w-[88%] sm:w-[64%] md:w-[52%] lg:w-[44%] xl:w-[38%] 2xl:w-[32%] rounded-2xl border border-black/10 bg-white/80 backdrop-blur shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-transform duration-300 will-change-transform hover:-translate-y-1 hover:scale-[1.03] hover:shadow-[0_16px_44px_rgba(0,0,0,0.08)]">
                  <a href="#" className="block">
                    ...
                    <div className="p-5 md:p-6">
                      ...
                      <button type="button" onClick={()=>setActiveProject(1)} className="mt-5 inline-flex items-center gap-2 text-[#2a6dfd] font-semibold hover:underline">
                        <span>View details</span>
                        <svg className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path d="M10.293 3.293a1 1 0 0 1 1.414 0l6 6a1 1 0 0 1 0 1.414l-6 6a1 1 0 1 1-1.414-1.414L14.586 11H3a1 1 0 1 1 0-2h11.586l-4.293-4.293a1 1 0 0 1 0-1.414Z"/></svg>
                      </button>
                    </div>
                ...
                <article data-card className="group relative snap-center shrink-0 w-[88%] sm:w-[64%] md:w-[52%] lg:w-[44%] xl:w-[38%] 2xl:w-[32%] rounded-2xl border border-black/10 bg-white/80 backdrop-blur shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-transform duration-300 will-change-transform hover:-translate-y-1 hover:scale-[1.03] hover:shadow-[0_16px_44px_rgba(0,0,0,0.08)]">
                  <a href="#" className="block">
                    ...
                    <div className="p-5 md:p-6">
                      <h4 className="text-lg font-semibold tracking-tight">Coming soon!</h4>
                      <button type="button" onClick={()=>setActiveProject(2)} className="mt-5 inline-flex items-center gap-2 text-[#2a6dfd] font-semibold hover:underline">
                        <span>View details</span>
                        <svg className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path d="M10.293 3.293a1 1 0 0 1 1.414 0l6 6a1 1 0 0 1 0 1.414l-5 5a1 1 0 1 1-1.414-1.414L11.586 10 7.293 5.707a1 1 0 0 1 0-1.414Z"/></svg>
                      </button>
                    </div>
                  </a>
                </article>
              ...
              <div className="pointer-events-none absolute inset-y-0 left-0 right-0 flex items-center justify-between px-2 sm:px-4">
                <button type="button" onClick={()=>handleProjectScroll('left')} className="pointer-events-auto inline-flex h-10 w-10 items-center justify-center rounded-full border border-black/10 bg-white/80 backdrop-blur shadow hover:shadow-md transition focus:outline-none focus:ring-2 focus:ring-[#2a6dfd]" aria-label="Previous">
                ...
                <button type="button" onClick={()=>handleProjectScroll('right')} className="pointer-events-auto inline-flex h-10 w-10 items-center justify-center rounded-full border border-black/10 bg-white/80 backdrop-blur shadow hover:shadow-md transition focus:outline-none focus:ring-2 focus:ring-[#2a6dfd]" aria-label="Next">
      ...
      {activeProject!==null&&(
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4" onClick={(e)=>{ if(e.currentTarget===e.target) setActiveProject(null) }}>
          <div role="dialog" aria-modal="true" className="relative w-full max-w-2xl rounded-2xl bg-white p-6 shadow-xl">
            <button onClick={()=>setActiveProject(null)} className="absolute top-3 right-3 rounded-full p-2 text-slate-600 hover:bg-slate-100" aria-label="Close">
            ...
            {activeProject===0&&(
              <div>
                ...
                <div className="mt-5 flex flex-wrap items-center gap-3">
                  ...
                  <a href="#" className="inline-flex items-center gap-2 rounded-full border border-[#2a6dfd] bg-[#2a6dfd]/10 px-4 py-2 text-sm font-semibold text-[#2a6dfd] hover:bg-[#2a6dfd]/20 transition">
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-50 border-t border-black/5 bg-[#2a6dfd] text-white">
        <div className="mx-auto max-w-6xl px-6 py-4 text-center text-base">Gregorius Jason, 2025</div>
      </footer>
    </div>
  )
}